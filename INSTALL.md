...
- 已明确指定或已确认沿用的主题优先。
- 未指定且未授权代选：先推荐清晰商务，备选最多两种已验证完整稿方向；提供每方向真实封面＋图表两页小样，优先直接展示渲染图片，用户选择后生成整稿。
...
若当前宿主不能渲染PPTX，应在让用户选择前说明，并让用户按文字方向选择或明确授权使用推荐主题；不能用色卡、网页示意或源SVG冒充PPT预览，也不能因用户暂时没有回复自动代选。标准稿完成后，只有实际可打开时才提供“预览完整稿”和“下载可编辑PPT”入口。
